...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String testusername = sharedpreferences.getString("username",null);
        if(testusername != null){
            String userType = sharedpreferences.getString("type",null);
            if(userType.equalsIgnoreCase("Citizen")){
                Intent activityChangeIntent = new Intent(MainActivity.this, CitizenActivity.class);
                // currentContext.startActivity(activityChangeIntent);
                finishAffinity();
                startActivity(activityChangeIntent);
            }
            else {
                Intent activityChangeIntent = new Intent(MainActivity.this, DriverActivity.class);
                // currentContext.startActivity(activityChangeIntent);
                finishAffinity();
                startActivity(activityChangeIntent);
            }
    ...
    private class AsyncRetrieve2 extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            editor.commit();
            if(result.equalsIgnoreCase("Citizen")){
                Intent activityChangeIntent = new Intent(MainActivity.this, CitizenActivity.class);
                // currentContext.startActivity(activityChangeIntent);
                finishAffinity();
